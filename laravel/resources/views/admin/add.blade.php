        ...
        <section id="content" class="container">
            <!-- Multi Column -->
                <div class="block-area" id="multi-column">
                    ...
                    <form class="row form-columned" role="form" method='post' action='index.php?m=stu&a=insert'>
                        <div class="col-md-4">
                            <input name='name' type="text" class="form-control input-sm m-b-10" placeholder="用户">
                        </div>
                        <div class="col-md-4">
                            <input name='age' type="text" class="form-control input-sm m-b-10" placeholder="年龄">
                        </div>
